...
const YOUTUBE_API_KEY = "AIzaSyDCaQIjSN2fJeybu-1E9ZW9hzIKGl2xK70";

const GOOGLE_CLIENT_ID = "540739574090-nb9s9is1on48oe28l4mtbj78bbbsh6hq.apps.googleusercontent.com";
...
interface GameListProps {
    ...
    homeTeamsAbbreviation: Map<string, string>; // Mapping home team name to abbreviation
    visitorTeamsAbbreviation: Map<string, string>; // Mapping visitor team name to abbreviation
}
